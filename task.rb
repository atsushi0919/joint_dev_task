...
def q6
  ...
  # 以下に回答を記載
  number2 = numbers1.map { |num| num * 10 }
  p number2
end
...
def q10
  ...
  favorite = "うに"
  foods.each do |food|
    puts food.include?(favorite) ? "好物です" : "まぁまぁ好きです"
  end
end
...
def q15
  ...
  #   puts data.each_key.to_a.include?(:age) ? "OK" : "NG"
  # end

  # 修正後
  [data1, data2].each do |data|
    puts data.keys.include?(:age) ? "OK" : "NG"
  end
end
